        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerMonth = table.Column<decimal>(type: "decimal(18,2)", nullable: false, comment: "Price per month"),
                    CategoryId = table.Column<int>(type: "int", nullable: false, comment: "Category identifier"),
                    AgentId = table.Column<int>(type: "int", nullable: false, comment: "Agent identifier"),
                    RenterId = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "User id of tenant")
                },
                constraints: table =>
                {
